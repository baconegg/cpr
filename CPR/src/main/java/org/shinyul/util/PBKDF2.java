...
public class PBKDF2 {
	...
	private static byte[] changeByte(String salt){
...
//		ArrayUtils.toPrimitive((Byte[]) list.toArray());
	...
	private static String changeDiget(byte[] digest){
		StringBuffer sb = new StringBuffer();
...
//		String p2 = "akbakb";
		...
		//test
		System.out.println(changeDiget(salt));
		System.out.println(changeDiget(d1));
		System.out.println(changeDiget(changeByte("DD9B497F1A791EE46F566D08EA3760D5ED2E98109A7771856D2A1E97D7354CA6")));
		System.out.println(changeDiget(pbkdf2(p1.toCharArray(), changeByte("DD9B497F1A791EE46F566D08EA3760D5ED2E98109A7771856D2A1E97D7354CA6"))));
		byte[] d3 = pbkdf2(p1.toCharArray(), changeByte("DD9B497F1A791EE46F566D08EA3760D5ED2E98109A7771856D2A1E97D7354CA6"));
		System.out.println("check 0 : "	+ authenticate(p1.toCharArray(), d3, changeByte("DD9B497F1A791EE46F566D08EA3760D5ED2E98109A7771856D2A1E97D7354CA6")));
