...
//        currentPoint = new nhn.api.map.LatLng(latitude, longitude);
	...
	// a.1. 상점 정보 불러와서 지도에 찍기 
	function fnShopInfo(currentPoint){
		
		$.post('/cpr/distanceMap', {curLat:currentPoint.y, curLng:currentPoint.x}).done(function(data2){
			...
			for(var i = 0; i < data2.length; i++){
				...
				// **************************
				//fnNewCurrentLocation()
// 				setInterval("fnNewCurrentLocation()", 2000);
		});
	} // end fnShopInfo
